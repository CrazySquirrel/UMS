...
describe('SearchPageView', () => {
  ...
  it('should create the SearchPageView', () => {
    const fixture = TestBed.createComponent(SearchPageView);
    const searchPageView = fixture.debugElement.componentInstance;
    expect(searchPageView).toBeTruthy();
  });
  ...
  it(`should render properly`, () => {
    ...
    expect(compiled.querySelector('h3').textContent).toContain('Search:');
    expect(!!compiled.querySelector('.mat-input-element[name="search"]')).toEqual(true);
  });
});
